...
export default function StudentRegister() {
	...
	function removeLanguage(learningLanguage: LanguageLevel) {
		const newLanguages = learningLanguages.filter((lang) => lang != learningLanguage);
		setLearningLanguages(newLanguages);
	}

	function changeKnowledgeLevel(language: LanguageLevel, level: KnowledgeLevel) {
					...
					>
						...
						>
							<p className="text-2xl my-2">
								...
								preferred teaching style and your
								goals!
							</p>
